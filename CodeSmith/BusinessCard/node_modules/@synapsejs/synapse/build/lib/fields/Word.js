...
var Word = /** @class */ (function (_super) {
    ...
    function Word(min, max, defaultVal, flags) {
        if (min === void 0) { min = null; }
        if (max === void 0) { max = null; }
        if (defaultVal === void 0) { defaultVal = undefined; }
        if (flags === void 0) { flags = null; }
        var _this = _super.call(this, min, max, defaultVal, flags) || this;
        _this.assert(/[^\w]/, false, "must contain only alphanumeric characters");
        return _this;
    }
    /**
     ...
     */
    Word.prototype.parse = function (value) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, valid.toLowerCase()];
                }
            });
        });
    };
